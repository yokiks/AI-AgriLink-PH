...
if (!$file || !is_array($file)) {
  ...
  if (!empty($validationErrors)) {
    ...
    if (empty($uploadError) && is_dir($uploadsDir) && is_writable($uploadsDir)) {
      ...
      if (!move_uploaded_file($file['tmp_name'], $targetPath)) {
        ...
        $uploadError = 'We could not save the uploaded file. Please try again. Error: ' . $errorMsg;
      } else {
      ...
      $uploadError = 'Uploads directory is not writable. Please check folder permissions.';
    }
  }
}
